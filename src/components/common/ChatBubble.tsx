...
const initialMessages: Message[] = [
  {
    id: 1,
    text: "Hello! I'm Abhiraj's Portfolio Assistant. How can I help you?",
    sender: 'bot',
    // Leave empty during SSR to avoid hydration mismatch; fill on client after mount
    timestamp: '',
  },
];
...
const ChatBubble: React.FC = () => {
  ...
  // Fill initial timestamp after client hydration to avoid SSR/client mismatch
  useEffect(() => {
    setMessages((prev) =>
      prev.map((m) =>
        m.timestamp === ''
      ...
      <ExpandableChatHeader>
        <div className="flex items-center space-x-3">
          <Avatar className="h-8 w-8 border-2 border-primary bg-blue-300 dark:bg-yellow-300">
            <AvatarImage src="/assets/logo.jpg" alt="Assistant" />
